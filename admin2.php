...
<head>
    ...
    <link rel="stylesheet" href="css/adminGold.css">
                            ...
                            <div class='col-lg-4 cont_employer'>
                                <div class='form-group'>
                                    <div class='form-floating'>
                                        <input type="text" class="form-control" id="txtTarjeta" maxlength='6' onkeypress='return validarTeclado(event,1);' >
                                        <label for="txtTarjeta"><i class="fas fa-id-card-alt"></i> Tarjeta</label>
                                    </div>
                                </div>
                            </div>
